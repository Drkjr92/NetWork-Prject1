...
public class server {
	...
	public static void main(String[] args) throws IOException {
		...
		ServerThread sThread = new ServerThread(number, serverSocket, ss);
		sThread.run();
...
class ServerThread implements Runnable
{
    ...
    public ServerThread(int number, ServerSocket serverSocket, Socket ss)
    {
        this.number = number;
    ...
    public void run()
    {
    	...
    	runServerThread(number, serverSocket, ss);

    }//end run


    public static String runServerThread(int number, ServerSocket serverSocket, Socket ss)
    {
    	String temp = "";//String used to output info from server
		long lineCount;//Long used to get # of lines from BufferedReader
		BufferedReader brRead, brCount;
    	...
    	//Get request based on user input
    			...
    			//Date & Time Request
    				...
    				case 6:
    					...
    					Process ps = Runtime.getRuntime().exec("ps -e");
...
}//end class ServerThread implements Runnable
